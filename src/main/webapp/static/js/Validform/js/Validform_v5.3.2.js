	...
	Validform.util={
		...
		enhance:function(tiptype,usePlugin,tipSweep,addRule){
			...
			curform.find("[datatype]").each(function(){
				if(tiptype==2){
					if($(this).parent().next(".Validform_checktip").length==0){
			...
			if(ajaxurl && !Validform.util.isEmpty.call($(this),inputval) && !bool){
				...
				var localconfig={
					...
					error: function(data){
						...
						if(data.codeText!=="abort"){
							var msg="status: "+data.code+"; statusText: "+data.statusText;
